    ...
    return (
        ...
        >
            ...
            >
                ...
                ></div>
                <div
                    className="work-4 absolute inset-1 bg-gray-400 rounded-2xl transition-all ease duration-300 origin-bottom select-none group-hover:[transform:rotateX(-20deg)]"
                ></div>
                <div
                    className="work-3 absolute inset-1 bg-gray-300 rounded-2xl transition-all ease duration-300 origin-bottom group-hover:[transform:rotateX(-30deg)]"
                ></div>
                <div
                    className="work-2 absolute inset-1 bg-gray-200 rounded-2xl transition-all ease duration-300 origin-bottom group-hover:[transform:rotateX(-38deg)]"
                ></div>
                <div
            ...
            <p className="text-3xl pt-4 opacity-20">BSIT S4A FILES</p>
        </section>
